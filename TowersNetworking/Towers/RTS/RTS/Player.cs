...
namespace RTS
{
    class Player
    {
        ...
        public Player(Game1 game, Vector2 startPosition, String textureName)
        {
            this.Initialize(game, startPosition);
            this.LoadContent(textureName);
        }
        ...
        public void setShootRotationAngle(double angle)
        {
            shootRotationAngle = angle;
        }
        ...
        public void setMoveRotationAngle(double angle)
        {
            moveRotationAngle = angle;
        }
